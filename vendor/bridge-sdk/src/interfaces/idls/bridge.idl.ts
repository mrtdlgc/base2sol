...
export const IDL = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [4, 153, 157, 132, 144, 253, 235, 44],
      accounts: [
        {
          name: "owner",
          docs: ["Owner authorized to modify the buffer"],
          signer: true,
        },
        {
          name: "prove_buffer",
          docs: ["Prove buffer account to append data to"],
          writable: true,
        },
      ],
      args: [
    ...
    },
    {
      ...
      discriminator: [234, 13, 59, 98, 112, 207, 250, 184],
      accounts: [
        {
          name: "owner",
          docs: ["Owner authorized to modify the buffer"],
        ...
        {
          name: "prove_buffer",
          docs: ["Prove buffer account to append proof nodes to"],
          writable: true,
        },
      ],
      args: [
    ...
    },
    {
      ...
      discriminator: [79, 14, 144, 49, 3, 124, 210, 74],
      accounts: [
        {
          name: "owner",
          docs: [
        ...
        {
          name: "prove_buffer",
          docs: ["The prove buffer account to close"],
          writable: true,
        },
      ],
      args: [],
    ...
    },
    {
      ...
      discriminator: [20, 200, 91, 188, 138, 211, 253, 222],
      accounts: [
        {
          name: "payer",
          docs: ["Payer funds the buffer account creation"],
          writable: true,
          signer: true,
        },
        {
    ...
    },
    {
      ...
      discriminator: [211, 48, 193, 183, 2, 51, 102, 159],
      accounts: [
        {
          name: "payer",
          docs: ["Payer funds the IncomingMessage account"],
          writable: true,
          signer: true,
        },
        {
          name: "output_root",
          docs: ["Output root to verify the proof against"],
        },
        {
          name: "message",
          docs: ["The incoming message account created if proof verifies"],
          writable: true,
        },
        {
          name: "bridge",
          docs: ["Bridge for pause check"],
        },
        {
          name: "owner",
          docs: ["Owner receives rent when buffer is closed"],
          writable: true,
          signer: true,
        },
        {
          name: "prove_buffer",
          docs: ["Prove buffer containing data and proof; closed on success"],
          writable: true,
        },
        {
          name: "system_program",
    ...
    },
    {
      ...
      accounts: [
        {
          name: "upgrade_authority",
          docs: ["The upgrade authority account"],
          signer: true,
        },
        {
          name: "bridge",
  ...
  accounts: [
    ...
    {
      name: "ProveBuffer",
      discriminator: [78, 160, 227, 163, 97, 140, 40, 149],
    },
  ],
  errors: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["The Base evm address of SOL"],
            type: {
              array: ["u8", 20],
            },
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "data",
            docs: ["Serialized `Message` data (Anchor-serialized)"],
            type: "bytes",
          },
          {
            name: "proof",
  ...
  constants: [
    ...
    },
    {
      ...
      type: "bytes",
      value:
        "[111, 117, 116, 103, 111, 105, 110, 103, 95, 109, 101, 115, 115, 97, 103, 101]",
    },
    {
