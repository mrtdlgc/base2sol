...
export const IDL = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [41, 191, 218, 201, 250, 164, 156, 55],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [197, 222, 225, 215, 15, 3, 82, 102],
      accounts: [
        {
          name: "cfg",
    ...
    },
    {
      ...
      discriminator: [244, 68, 172, 138, 187, 145, 160, 192],
      accounts: [
        {
          name: "cfg",
          docs: ["The bridge account containing configuration"],
  ...
  accounts: [
    {
      name: "Cfg",
      discriminator: [236, 69, 240, 199, 189, 123, 35, 99],
    },
    {
      name: "MessageToRelay",
      discriminator: [194, 113, 145, 222, 76, 51, 252, 102],
    },
  ],
  errors: [
    {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "nonce",
            docs: ["Canonical nonce"],
            type: "u64",
          },
          {
            name: "guardian",
            docs: ["Guardian pubkey authorized to update configuration"],
            type: "pubkey",
          },
          {
            name: "eip1559",
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Current base fee in gwei (runtime state)"],
            type: "u64",
          },
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "target",
            docs: ["Gas target per window (configurable)"],
            type: "u64",
          },
          {
            name: "denominator",
          ...
          },
          {
            ...
            docs: ["Window duration in seconds (configurable)"],
            type: "u64",
          },
          {
            name: "minimum_base_fee",
            docs: ["Minimum base fee floor (configurable)"],
            type: "u64",
          },
        ],
      },
        ...
        fields: [
          {
            ...
            docs: ["Minimum gas limit per cross-chain message"],
            type: "u64",
          },
          {
            name: "max_gas_limit_per_message",
            docs: ["Maximum gas limit per cross-chain message"],
            type: "u64",
          },
          {
            name: "gas_cost_scaler",
            docs: ["Scaling factor for gas cost calculations"],
            type: "u64",
          },
          {
            name: "gas_cost_scaler_dp",
            docs: ["Decimal precision for gas cost calculations"],
            type: "u64",
          },
          {
            name: "gas_fee_receiver",
            docs: ["Account that receives gas fees"],
            type: "pubkey",
          },
        ],
      },
